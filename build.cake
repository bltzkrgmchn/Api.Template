...
var solution = "Api.Template.sln";
var releaseNotesPath = "./RELEASE_NOTES.md";
var binaries = "./Sources/Api.Template.Instance/bin";
var objects = "./Sources/Api.Template.Instance/obj";
...
Task ("Version")
    .Does (() => {
        ...
        var file = "./Sources/Api.Template.Instance/AssemlyInfo.cs";
...
Task ("Publish")
    ...
    .Does (() => {
        ...
        DotNetCorePublish("./Sources/Api.Template.Instance/Api.Template.Instance.csproj", settings);
